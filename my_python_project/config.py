...
# Logic Factors
MARKET_LOOKBACK_HOURS = 2 # Сокращаем окно, чтобы ловить первичную реакцию, а не шум
DECAY_FACTOR = 0.9 # Увеличиваем скорость затухания для более быстрой адаптации к новым данным
